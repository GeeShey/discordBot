...
public class Victory extends ListenerAdapter {
	public void onMessageReceived(MessageReceivedEvent event) {

		String[] args = event.getMessage().getContentRaw().split("\\s+");

		if (args[0].equalsIgnoreCase(LeaderMan.prefix + "victory")) {
			...
			if (args.length != 4) {
				...
				event.getChannel().sendMessage("Please enter 3 names in front of !victory").queue();
				...
				// TODO
				// split the entire string into string array
